<template>
	<div class="record" @click.stop="stop">
		<el-tabs style="padding: 0 20px;" v-model="activeName" @tab-click="handleClick">
				...
				<div v-show="addFlag" class="addReportMsg">
					<div style="display: flex">
						<div style="margin-right: 10px;">
							<el-date-picker :editable="editable" v-model="reportTime" type="date" placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss">
							</el-date-picker>
							<!--<i class="iconfont icon-rili1" style="cursor: pointer;"></i>-->
						</div>
						<div style="width: 100%;">
							<el-input type="textarea" :rows="2" placeholder="请输入进度汇报" maxlength="200" minlength="15" v-model="reportStr">
							</el-input>
						</div>
					</div>
				...
				<ul class="reportList">
					<li v-for="(item,index) in reportList">
						...
						<div v-if="item.edit">
							<div style="display: flex">
								<div style="margin-right: 10px;">
									<el-date-picker :editable="editable" v-model="item.reportTime" type="date" placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss">
									</el-date-picker>
									<!--<i class="iconfont icon-rili1" style="cursor: pointer;"></i>-->
								</div>
								<div style="width: 100%;">
									<el-input type="textarea" :rows="2" placeholder="请输入进度汇报" maxlength="200" minlength="15" v-model="item.reportStr">
									</el-input>
								</div>
							</div>
							<div style="display: flex;justify-content: flex-end;margin-top: 10px;">
			...
			<el-tab-pane label="日志动态" name="logs">
				<ul class="reportList">
					<li v-for="item in logList">
						<el-row>
							...
							<el-col :span="18" style="word-wrap: break-word;word-break:break-all;white-space: normal;">
								{{item.content}}
							</el-col>
							<el-col :span="2">
								<img class="img" v-if="item.user.user_img!=''" :src="item.user.user_img" />
