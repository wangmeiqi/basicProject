...
<template>
	<div @click.stop="">
		<div class="memberListBox" :style="styles">
			<div class="search">
				<el-input v-model="searchInput" placeholder="查找成员"></el-input>
			</div>
			<ul>
				<li class="memberRow" @click.stop="clickTopOption">
					<div>
				...
				<li class="memberRow" v-for="(member,index) in memberListMol" @click.stop="clickOption(index)">
					<div>
				...
				<!--<li class="memberRow" @click.stop="addMembershow=!addMembershow">
					<div>
		...
		watch:{
            ...
            searchInput(val){
                if(val != ''){
                    this.memberListMol = []
                    this.memberList.map(el => {
                        //console.log(el,123456666666666666)
